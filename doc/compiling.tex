...
You will still need to set up a few things though: first, you need to install Python 2.6.x \footnote{
Please make sure that you get a Python binary matching the architecture, for which you plan to compile
Mitsuba (i.e. \code{x86} or \code{x86\_64}) -- this is needed for the Python bindings. If you wish to
...
that is missing SP1. Once that is taken care of, start the correct Visual Studio command 
prompt, and enter
\begin{shell}
