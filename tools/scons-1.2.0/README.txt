...
# src/README.txt 3842 2008/12/20 22:59:52 scons
...
In this case, your options are:
    ...
    --  (Recommended.)  Install from a pre-packaged SCons package that
        does not require distutils:
            ...
            Red Hat Linux       scons-1.2.0-1.noarch.rpm

            Debian GNU/Linux    scons_1.2.0-1_all.deb
                                (or use apt-get)
...
By default, the above command will do the following:
    ...
    --  Install scripts named "scons" and "sconsign" scripts in the
        ...
        "sconsign-1.2.0" scripts by specifying the "--hardlink-scons"
    ...
    --  Install "scons-1.2.0.bat" and "scons.bat" wrapper scripts in the
        ...
        specified to have "scons-1.2.0.bat" and "scons.bat" files
